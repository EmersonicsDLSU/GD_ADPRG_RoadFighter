...
void GameScene::onLoadObjects()
{
    ...
    BGObject* bgObject = new BGObject("BGObject", "road_1");
...
void GameScene::instantiateEnemySpawn(EmptyGameObject* eg, int size, std::string handlerName,
...
float GameScene::RandomFloat(float a, float b)
{
    srand(time(NULL));
