...
void GameScene3::onLoadObjects()
{
    ...
    BGObject* bgObject = new BGObject("BGObject", "road_3");
...
void GameScene3::instantiateEnemySpawn(EmptyGameObject* eg, int size, std::string handlerName,
...
float GameScene3::RandomFloat(float a, float b)
{
    srand(time(NULL));
